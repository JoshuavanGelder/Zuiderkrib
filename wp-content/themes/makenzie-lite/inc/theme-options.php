...
function makenzie_lite_customizer_register_options( $options ) {
	...
	$options[] = array(
		'type'	=> 'section',
		'id'	=> 'makenzie_lite_teaser_options',
		'title' => __( '- Home Page Slider/Teaser', 'makenzie-lite' ),
	);

		$options[] = array(
			'type'	=> 'option_select',
			'opts'  => array(
				'slider-1' => __( 'Single Slide Style', 'makenzie-lite' ),
				'slider-2' => __( '3 Slides Style', 'makenzie-lite' ),
			),
			'title' => __( 'Teaser Style', 'makenzie-lite' ),
			'id'	=> $prefix . 'teaser_styles',
			'def'	=> 'slider-1',
		);

		$options[] = array(
			'type'	=> 'option_text',
			'title' => __( 'Tag Slug (Posts > Tag > Edit the tag to find the slug. Will display posts from a specific tag.)', 'makenzie-lite' ),
			'id'	=> $prefix . 'teaser_tag_slug',
			'def'	=> '',
		);

		$options[] = array(
			'type'	=> 'option_text',
			'title' => __( 'Number of Posts', 'makenzie-lite' ),
			'id'	=> $prefix . 'teaser_number_post',
			'def'	=> '5',
		);
		...
		$options[] = array(
			'type'	=> 'option_select',
			'opts'  => array(
				'yes' => __( 'Yes', 'makenzie-lite' ),
				'no' => __( 'No', 'makenzie-lite' ),
			),
			'title' => __( 'Display Category', 'makenzie-lite' ),
			'id'	=> $prefix . 'teaser_category',
			'def'	=> 'yes',
		);
		...
		$options[] = array(
			...
			'title' => __( 'Display Excerpt', 'makenzie-lite' ),
			'id'	=> $prefix . 'teaser_excerpt',
			'def'	=> 'no',
		);
		...
		$options[] = array(
			...
			'title' => __( 'Display Button', 'makenzie-lite' ),
			'id'	=> $prefix . 'teaser_button',
			'def'	=> 'yes',
		);
	...
	$options[] = array(
		...
		$options[] = array(
			...
			'title' => __( 'Page Title', 'makenzie-lite' ),
			'id'	=> $prefix . 'page_title_on_off',
			'def'	=> 'on',
		);
		...
		$options[] = array(
			...
			'title' => __( 'Archive Page Title', 'makenzie-lite' ),
			'id'	=> $prefix . 'archive_title_on_off',
			'def'	=> 'on',
		);
		...
		$options[] = array(
			...
			'title' => __( 'Search Page Title', 'makenzie-lite' ),
			'id'	=> $prefix . 'search_title_on_off',
			'def'	=> 'on',
		);
...
function makenzie_lite_customizer_frontend_custom_css() {
	...
	// append to style.css
	wp_add_inline_style( 'makenzie-style', $custom_css );

} add_action( 'wp_enqueue_scripts', 'makenzie_lite_customizer_frontend_custom_css');
